...
import com.modou.core.modouHttpResponse;
import com.modou.core.enums.RequestMethod;
import com.modou.core.kit.AesUtil;
import com.modou.core.kit.HttpKit;
import com.modou.core.kit.PayKit;
import com.modou.core.kit.WxPayKit;
import com.modou.core.utils.DateTimeZoneUtil;
import com.modou.demo.entity.WxPayV3Bean;
import com.modou.wxpay.WxPayApi;
import com.modou.wxpay.enums.WxApiType;
import com.modou.wxpay.enums.WxDomain;
import com.modou.wxpay.model.v3.Amount;
import com.modou.wxpay.model.v3.Payer;
import com.modou.wxpay.model.v3.UnifiedOrderModel;
...
public class WxPayV3Controller {
    ...
    public String index() {
        ...
        return ("欢迎使用 modou 中的微信支付 Api-v3 -by 金钰鑫  <br/><br>  ");
    }
...
//            System.out.println("签名：" + certificate.getSignature().toString());
    ...
    public String v3Get() {
        // 获取平台证书列表
        try {
            modouHttpResponse response = WxPayApi.v3(
                    RequestMethod.GET,
    ...
    public String put() {
        try {
            ...
            params.put("url","https://gitee.com/javen205/modou");
    ...
    public String payScoreUserServiceState() {
        try {
            ...
            modouHttpResponse result = WxPayApi.v3(
                    RequestMethod.GET,
                    WxDomain.CHINA.toString(),
    ...
    public String cipher() {
        try {
            // 敏感信息加密
            X509Certificate certificate = PayKit.getCertificate(FileUtil.getInputStream(wxPayV3Bean.getPlatformCertPath()));
            String encrypt = PayKit.rsaEncryptOAEP("modou", certificate);
     ...
     * 申请交易账单
     *
     * @param billDate  当天账单后一天出，不然会出现「账单日期格式不正确」错误
     * @return 交易账单下载地址
     */
